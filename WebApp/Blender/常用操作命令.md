...
```
bpy.context.active_object.data.materials[0].node_tree.nodes[0].inputs["Base Color"].default_value = (0, 1, 0, 0.8)

import bpy
ob = bpy.context.active_object
dir(bpy.context.active_object.data.materials[0])
# Get material
...
for i in range (0,30):
  ...
  bpy.context.object.rotation_euler[0]=uniform(0,3.14159)
  bpy.context.object.rotation_euler[1]=uniform(0,3.14159)
  bpy.context.object.rotation_euler[2]=uniform(0,3.14159)
  bpy.context.object.location[0] = uniform(0,1)+2*i*uniform(-1,1)
  #bpy.context.object.location[1] = uniform(0,1)+2*i*uniform(-1,1)
  bpy.context.object.location[2] = uniform(5,9)
```
...
```
bpy.ops.object.duplicate_move()
bpy.ops.transform.rotate(value=1.62738, orient_axis='Z')
```